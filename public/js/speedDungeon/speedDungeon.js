...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const LOCK_DOOR_IMAGES = {
    3: [
      "/images/speedDungeon/lockgame/door3a.webp",
      "/images/speedDungeon/lockgame/door3b.webp",
      "/images/speedDungeon/lockgame/door3c.webp"
    ],
    4: [
      "/images/speedDungeon/lockgame/door4a.webp",
      "/images/speedDungeon/lockgame/door4b.webp",
      "/images/speedDungeon/lockgame/door4c.webp",
      "/images/speedDungeon/lockgame/door4d.webp"
    ],
    5: [
      "/images/speedDungeon/lockgame/door5a.webp",
      "/images/speedDungeon/lockgame/door5b.webp",
      "/images/speedDungeon/lockgame/door5c.webp"
    ]
  };
  ...
  async function loadImageDataIfNeeded() {
    ...
    try {
      const [data0_7, data8_11, data12_15, data16_plus] = await Promise.all([
        safeLoad("/data/speedDungeon-search0-7.json"),
        safeLoad("/data/speedDungeon-search8-11.json"),
        safeLoad("/data/speedDungeon-search12-15.json"),
        safeLoad("/data/speedDungeon-search16+.json")
      ]);
  ...
  async function loadRiddleDataIfNeeded() {
    ...
    try {
      const [res0_7, res8_11, res12_15, res16_plus] = await Promise.all([
        fetch("/data/speedDungeon-riddles0-7.json", { cache: "no-store" }),
        fetch("/data/speedDungeon-riddle8-11.json", { cache: "no-store" }),
        fetch("/data/speedDungeon-riddle12-15.json", { cache: "no-store" }),
        fetch("/data/speedDungeon-riddle16+.json", { cache: "no-store" })
      ]);
